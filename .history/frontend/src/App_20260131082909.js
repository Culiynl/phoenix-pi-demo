                                ...
                                <div key={i} style={{ background: '#18181b', padding: '15px', borderRadius: '8px', marginBottom: '20px', border: '1px solid #333' }}>
                                    ...
                                    <div style={{ fontSize: '0.9rem' }}>
                                        ...
                                        {Array.isArray(route.steps) && route.steps.map((step, s) => (
                                            console.log("STEP OBJECT:" + JSON.stringify(step));
                                        return (<div key={s} style={{ marginBottom: '10px', padding: '8px', background: '#27272a', borderRadius: '4px' }}>
                                            ...
                                            <div style={{ color: '#6b7280', fontSize: '0.8rem', marginTop: '2px' }}>
                                                Template: {step.reaction_smarts ? (step.reaction_smarts.length > 50 ? step.reaction_smarts.substring(0, 50) + "..." : step.reaction_smarts) : "N/A"}
                                            </div>
                                        </div>);
                                ))}
                                    </div>
