...
class PDBManager:
    ...
    def get_p2rank_results(pdb_filename: str, project_id: str):
        ...
        # Aggressive Search: Look for any CSV that has the ID in it
        # This finds 9BA8_predictions.csv OR 9BA8.cif_predictions.csv
        ...
        try:
            ...
            # Explicitly map columns to ensure types are correct for JSON
            return [{
                "rank": int(row['rank']),
