...
class DockingManager:
    ...
    def run_docking(project_id: str, smiles: str):
        ...
        try:
            ...
            # 3. Convert only the Ligand to PDB (preserving Models)
            score = 0.0
            if os.path.exists(ligand_pdbqt):
                ...
                # Use the function you already have that preserves MODEL tags
            ...
            return {
                ...
                "receptor_url": f"/static/receptor/6od6_clean.pdb", # Static path
                "run_id": run_id
            }
