...
def run_docking(project_id, smiles, center_override=None):
    # If center_override is provided, use it instead of calculate_pocket_center
    center = center_override if center_override else calculate_pocket_center(DEFAULT_POCKET_PDB)
